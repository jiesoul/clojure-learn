(ns com.jiesoul.four-clojure.core)
...
;In a family of languages like Lisp, having balanced parentheses is a defining feature of
; the language. Luckily, Lisp has almost no syntax, except for these "delimiters" --
...
; of length 2n (n pairs of parentheses). For this problem,
